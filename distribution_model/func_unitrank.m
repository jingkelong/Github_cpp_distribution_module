function [coal_d2]=func_unitrank(total_cap,yr,coal_d)  % totalcap:预测装机总量； yr:年份;coal_d:数据总数 aaa:输出变量
% function [coal_d2,coal_t2]=unitrank(total_cap,yr,coal_d,coal_t)  % totalcap:预测装机总量； yr:年份;coal_d:数据总数 aaa:输出变量

% clear
% b=importdata("D:\05-3E\20191230电厂数据\ChinaPowerPlant电厂机组数据\ChinaPowerPlant-3E-v56.xlsx");
